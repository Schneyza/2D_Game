...
public class TileMapEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        map.isForeground = EditorGUILayout.Toggle("ForeGround", map.isForeground);
        ...
        else
        {
            ...
            EditorGUILayout.LabelField("Pixels To Units", map.pixelsToUnit.ToString());
    ...
    void UpdateCalculations()
    {
        ...
        map.spriteReferences = AssetDatabase.LoadAllAssetRepresentationsAtPath(path);
        ...
        map.pixelsToUnit = (int)(sprite.rect.width / sprite.bounds.size.x);
        map.gridSize = new Vector2((width / map.pixelsToUnit) * map.mapSize.x, (height / map.pixelsToUnit) * map.mapSize.y);
    ...
    void CreateBrush()
    {
        ...
        if (sprite != null)
        {
            ...
            var pixelsToUnits = map.pixelsToUnit;
    ...
    void MoveBrush()
    {
        var tileSize = map.tileSize.x / map.pixelsToUnit;
    ...
    void DrawWithCollider()
    {
        ...
        if (tile.GetComponent<BoxCollider2D>() == null)
        {
            ...
            tile.GetComponent<BoxCollider2D>().size = new Vector2(map.tileSize.x, map.tileSize.y);
            IconManager.SetIcon(tile, IconManager.LabelIcon.Red);
        }
        if (map.isForeground)
        {
